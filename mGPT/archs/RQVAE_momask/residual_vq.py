...
class ResidualVQ(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # self.layers = QuantizeEMAReset(**kwargs)
    ...
    def forward(self, x, return_all_codes = False, sample_codebook_temp = None, force_dropout_index=-1):
        ...
        ret = (quantized, all_indices, all_losses, all_perplexity)
        ...
        # for quantizer_index, layer in enumerate(self.layers):
        #     ret = layer(residual, return_idx=True, temperature=sample_codebook_temp)
